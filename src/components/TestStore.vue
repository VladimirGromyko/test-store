...
export default {
  ...
  watch: {
     ...
     * вызов функции для обновления цен товаров в корзине в зависимости от изменившегося курса валюты.
     ...
     * вызов функции изменения цен товаров,
     * вызов функции изменения данных по ценам у текущей выбранной товарной группы,
     * вызов функции для обновления цен товаров в корзине в зависимости от изменившихся валютных цен и курса валюты.
  ...
  methods: {
    ...
    addPurchase(item) {
      ...
      // Изменяем состояние покупок для дальнейшего контроля за остатками товара
